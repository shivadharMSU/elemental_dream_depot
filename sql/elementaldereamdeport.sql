CREATE USER 'elementalroot'@'localhost' IDENTIFIED BY 'elementalpassword';
GRANT ALL PRIVILEGES ON elemental_dream_depot.* TO 'elementalroot'@'localhost';
FLUSH PRIVILEGES;

-- MySQL dump 10.13  Distrib 8.3.0, for macos14 (arm64)
--
-- Host: localhost    Database: elemental_dream_depot
-- ------------------------------------------------------
...
--
-- Dumping routines for database 'elemental_dream_depot'
--
...
-- Dump completed on 2024-04-03 18:52:39
